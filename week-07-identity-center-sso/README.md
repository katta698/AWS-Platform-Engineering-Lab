...
After apply, sign in to the Identity Center **AWS access portal** URL (shown in the Identity Center console) as one of the test users — they'll see every Sandbox/Production account they're assigned to, and can pick a role to federate into it with temporary credentials.
