...
echo "within a few minutes. Track with (note: real rule names carry an extra"
echo "AWS-generated suffix, e.g. week12-required-tags-conformance-pack-<id>):"
echo "  aws configservice describe-conformance-pack-compliance --region $REGION \\"
echo "    --conformance-pack-name week12-cfgcompliance-pack"
echo ""
